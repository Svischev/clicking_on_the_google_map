  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved building as @building" do
        ...
        post :create, {:building => { "address" => "invalid value" }}, valid_session
        assigns(:building).should be_a_new(Building)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested building" do
        ...
        Building.any_instance.should_receive(:update).with({ "address" => "MyString" })
        put :update, {:id => building.to_param, :building => { "address" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the building as @building" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Building.any_instance.stub(:save).and_return(false)
        put :update, {:id => building.to_param, :building => { "address" => "invalid value" }}, valid_session
        assigns(:building).should eq(building)
      end
